    ...
    <div class="contenedor-anuncios">
        ...
        <div class="anuncio">
            ...
            <picture>
                ...
                <img src="build/img/anuncio1.jpg" alt="anuncio1.jpg" loading="lazy">
            </picture>
        ...
        <div class="anuncio">
            ...
            <picture>
                ...
                <img src="build/img/anuncio2.jpg" alt="anuncio2.jpg" loading="lazy">
            </picture>
            <!-- Información del anuncio -->
            <div class="contenido-anuncio">
        ...
        <div class="anuncio">
            ...
            <picture>
                ...
                <img src="build/img/anuncio3.jpg" alt="anuncio3.jpg" loading="lazy">
            </picture>
            <!-- Información del anuncio -->
            <div class="contenido-anuncio">
...
<div class="contenedor seccion seccion-inferior">
    ...
    <section class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>
                El personal se comportó de una excelente forma, muy buena atención y lal casa que me ofrecieron cumple con todas mis expectativas.
            </blockquote>
            <p>- Carlos Amezcua</p>
        </div>
    </section>
